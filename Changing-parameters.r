...
# Define parameters
param$Dv <- 10.8*3 # Diffusivity (m^2/d)
...
N0 <- c(0.1631374,  0.1832916 , 0.2238936 , 0.2854092,  0.3682608 , 0.4725690 , 0.5979124,  0.7431647,  0.9064525,  1.0852453,
...
A0 <- c(0.1308610,  0.1434906,  0.1689071,  0.2073515,  0.2590228,  0.3239333,  0.4017857,  0.4919028,
...
INIT <- c(N0, rep(0.05,param$n), rep(0.001,param$n), A0, rep(0.01,param$n), rep(0.0001,param$n), rep(0.01,param$n))
